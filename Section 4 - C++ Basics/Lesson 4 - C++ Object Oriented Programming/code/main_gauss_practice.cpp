...
// Either redeclare and run the files together, or just add
...
int main () {
   ...
   */
    ...
    */
    cout << "Gaussian One when x = 10.5: " << gaussianone.evaluate(10.5) << endl;
    cout << "Gaussian One when x = 55.4: " << gaussianone.evaluate(55.4) << endl;
    cout << "Gaussian One when x = 35.6: " << gaussiantwo.evaluate(35.6) << endl;
    cout << "Gaussian One when x = 29.4: " << gaussiantwo.evaluate(29.4) << endl;
    ...
    */
    ...
    cout << "mean of gaussian one " << gaussianone.getMu() << endl;
    cout << "variance of gaussian two " << gaussiantwo.getSigma2() << endl;
    ...
    */
    ...
    cout << "mean of gaussian three is " << gaussianthree.getMu() << endl;
    cout << "variance of gaussian three is " << gaussianthree.getSigma2() << endl;

    Gaussian gaussianfour = gaussianone.add(gaussiantwo);

    cout << "mean of gaussian four is " << gaussianfour.getMu() << endl;
    cout << "variance of gaussian four is " << gaussianfour.getSigma2() << endl;
